...
Das Repository veröffentlicht Quellen und Dokumentation. PSPDEV, PSPGL, SDL 1.2, SDL_image, SDL_ttf, SDL_mixer, FreeType und die Codec-Bibliotheken werden aus dem angegebenen SDK-Container eingebunden und behalten ihre eigenen Lizenzen. Bei einer späteren Weitergabe kompilierter Pakete müssen zusätzlich die Lizenztexte und erforderlichen korrespondierenden Quellen der tatsächlich eingebundenen Bibliotheken mitgeliefert bzw. regelkonform bereitgestellt werden. Eine solche Binärveröffentlichung ist hier nicht enthalten.
