...
**Hardware status:** v0.5.0 has a reported physical PSP shutdown during resource loading. The cause is unresolved; emulator test results do not establish that this release works on real hardware. See the [shutdown investigation](docs/startup-validation.md#v050-physical-shutdown-report).
